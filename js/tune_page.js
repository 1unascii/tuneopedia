$(document).ready(function () {
    ...
    $(document).on('click', '.edit-setting-btn', function () {
        ...
        $.get('edit_setting.php', { setting_id: settingId }, function (html) {
            $editArea.html(html);
    ...
    $(document).on('submit', '.edit-setting-form', function (e) {
        ...
        $.post('edit_setting.php', $form.serialize(), function (data) {
            if (data.error) {
    ...
    $(document).on('click', '.vote-btn', function () {
        ...
        var userId     = parseInt($('#user-info').data('user-id') || 0);
