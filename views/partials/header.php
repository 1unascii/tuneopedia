...
<script type="text/javascript" src="<?= $assetBase ?>js/modules/abc-editor.js?v=29"></script>
<script type="text/javascript" src="<?= $assetBase ?>js/modules/tunes/index.js?v=12"></script>
<script type="text/javascript" src="<?= $assetBase ?>js/modules/settings/show.js?v=5"></script>
