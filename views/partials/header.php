...
<script src='<?= $assetBase ?>js/lib/abcjs-basic.js?v=3' type='text/javascript'></script>
...
<script type="text/javascript" src="<?= $assetBase ?>js/modules/tunes/show.js?v=27"></script>
